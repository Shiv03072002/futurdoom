    ...
    <div className="bg-gradient-to-br from-[#0f1f6e] via-[#1a3aad] to-[#2563eb] p-6 relative overflow-hidden">
      ...
      <div className="relative">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-blue-200 text-xs tracking-[0.2em] uppercase font-medium">Community</span>
        </div>
        <div className="flex items-center justify-between">
          ...
          <span className="bg-white/20 text-white text-xs font-semibold px-3 py-1.5 rounded-full border border-white/30 flex items-center gap-1">
